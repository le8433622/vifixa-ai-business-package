...
export default function WorkerChatScreen() {
  ...
  async function checkAuth() {
    ...
    setMessages([{
      ...
      content: 'Xin chào! 🔧 Tôi là AI Co-pilot của bạn.\n\nTôi sẽ giúp bạn tối ưu thu nhập, gợi ý việc phù hợp và hỗ trợ trong lúc làm.',
    }]);
  }
...
const styles = StyleSheet.create({
  ...
  sendBtn: { backgroundColor: '#059669', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 20 },
