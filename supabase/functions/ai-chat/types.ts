...
export interface AutonomyPolicy {
  ...
  category_overrides?: Record<string, { min_confidence?: number; max_auto_order_value?: number }>
}
...
export interface ChatAction {
  type: 'quick_reply' | 'share_location' | 'upload_media' | 'quote_card' | 'confirmation_card' | 'view_order' | 'talk_to_human' | 'approval_pending' | 'upsell_card' | 'membership_card'
  label: string
  value?: string
  data?: unknown
}
